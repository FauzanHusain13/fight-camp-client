    ...
    return (
        <div className="mt-14 grid grid-cols-1 sm:grid-cols-2 gap-4 md:flex md:justify-start lg:gap-5 mx-auto">
            {trainingItem.map(item => {
                return(
                    <Link href="/detail" key={item._id} className="bg-[url('/img/gambar-training.jpg')] rounded-md bg-left p-5 flex-initial w-full lg:w-64 lg:hover:w-96 transition-all duration-700 cursor-pointer">
