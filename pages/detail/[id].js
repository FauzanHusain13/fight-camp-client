        ...
        <div className="px-4 md:px-16 lg:px-52 mt-[-40px] m-auto">
            ...
            <div className="mt-10 text-white">
                ...
                <form action="/checkout" method="POST" className="mt-8">
                    ...
                    <div className="mt-8">
                        <label for="my-select" className="block text-gray-300 text-sm font-bold mb-2">Discount:</label>
                        <div className="relative">
                            <select id="my-select" className="block appearance-none w-full bg-black border border-gray-300 text-white py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:border-red-500">
